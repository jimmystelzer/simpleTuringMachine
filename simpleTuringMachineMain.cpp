...
simpleTuringMachineFrame::simpleTuringMachineFrame(wxWindow* parent,wxWindowID id)
{
    ...
    {
    	wxIcon FrameIcon;
    	FrameIcon.CopyFromBitmap(wxBitmap(wxImage(_T("/home/jimmy/projects/simpleTuringMachine/res/stm_16x16.png"))));
    	SetIcon(FrameIcon);
    }
    ...
    StaticBitmap2 = new wxStaticBitmap(panel1, ID_STATICBITMAP2, wxBitmap(wxImage(_T("/home/jimmy/projects/simpleTuringMachine/res/seta.png"))), wxPoint(249,36), wxDefaultSize, 0, _T("ID_STATICBITMAP2"));
    StaticBitmap3 = new wxStaticBitmap(panel1, ID_STATICBITMAP3, wxBitmap(wxImage(_T("/home/jimmy/projects/simpleTuringMachine/res/seta.png"))), wxPoint(249,84), wxDefaultSize, 0, _T("ID_STATICBITMAP3"));
    StaticBitmap1 = new wxStaticBitmap(panel1, ID_STATICBITMAP1, wxBitmap(wxImage(_T("/home/jimmy/projects/simpleTuringMachine/res/seta.png"))), wxPoint(249,132), wxDefaultSize, 0, _T("ID_STATICBITMAP1"));
